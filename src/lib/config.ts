...
export const APP_CONFIG = {
  appName: "Full Throttle",                        // Display name (sidebar header, page title)
  projectName: "Full Throttle",                    // Client's product name (tab bar microtext, footer)
  clientName: null as string | null,               // Client first name, or null — never render "null"
  domain: "powersport-automation",                 // Domain (finance, health, marketplace, tech, etc.)
